...
export const metadata: Metadata = {
    metadataBase: new URL(
        process.env.NODE_ENV === 'production' ? 'https://sureyyaalper.com' : 'http://localhost:3000'
    ),
    title: 'Süreyya Alper - Geleneksel Türk Sanatları Ustası | Müzehhibe',
    description:
        "Geleneksel müzehhiplik sanatını modern yorumlarla harmanlayan usta sanatçı Süreyya Alper'in eserlerini, biyografisini ve çalışmalarını keşfedin. Tezhip konularında uzman müzehhibe.",
    keywords: [
        'müzehhibe',
        'müzehhiplik',
        'tezhip',
    ...
    openGraph: {
        ...
        description:
            'Müzehhiplik sanatının inceliklerini modern yaklaşımlarla buluşturan usta sanatçı',
